	...
	public function index(\WP_REST_Request $request): \WP_REST_Response
	{
		...
		try {
			$response = wp_remote_get(
				bsaGetConfig('BSA_API_BASE_URL') . '/license-manager/v1/clients',
				[
					'timeout' => 30,
					'redirection' => 5,
					'httpversion' => '1.1',
			...
			if (empty($body['success']) || !isset($body['data']['subscriptions']) || empty($body['data']['subscriptions'])) {
				return new \WP_REST_Response([
					'code' => 400,
					'success' => false,
			...
			$licenses = array_map(function (array $subscription) {
		...
		$body['data']['subscriptions'] = $licenses;
	...
	public function create(\WP_REST_Request $request): \WP_REST_Response
	{
		...
		try {
			...
			$response = wp_remote_post(
				bsaGetConfig('BSA_API_BASE_URL') . '/license-manager/v1/domains',
				[
					'timeout' => 30,
					'redirection' => 5,
					'httpversion' => '1.1',
	...
	public function delete(\WP_REST_Request $request): \WP_REST_Response
	{
		...
		try {
			...
			$response = wp_remote_request(
				bsaGetConfig('BSA_API_BASE_URL') . '/license-manager/v1/domains/' . $request->get_param('domain_id'),
				[
					'method' => 'DELETE',
					'timeout' => 30,
					'redirection' => 5,
